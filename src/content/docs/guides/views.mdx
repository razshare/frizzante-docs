...
func Hello(con *libcon.Connection) {
    ...
    con.SendView(libview.View{Name: "Hello"}) 
}
```
...
<Tabs>
    <TabItem label='RenderModeFull'>
        ...
        func Hello(con *libcon.Connection) {
            con.SendView(libview.View{
                Name: "Hello",
                RenderMode: libview.RenderModeFull, // Renders on server 
                                                   // and client.
            })
        }
        ```
    ...
    <TabItem label='RenderModeServer'>
        ...
        func Hello(con *libcon.Connection) {
            con.SendView(libview.View{
                Name: "Hello",
                RenderMode: libview.RenderModeServer, // Renders on server.
            })
        }
        ```
        :::tip
    ...
    <TabItem label='RenderModeClient'>
        ...
        func Hello(con *libcon.Connection) {
            con.SendView(libview.View{
                Name: "Hello",
                RenderMode: libview.RenderModeClient, // Renders on client.
            })
        }
        ```
    </TabItem>
