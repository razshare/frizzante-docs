...
func Welcome(connection *connections.Connection) {
    connection.SendView(views.View{Name: "Welcome"}) // Sends view "Welcome".
}
```
...
func Welcome(connection *connections.Connection) {
    connection.SendFileOrElse(func () {                  // Attempts to send requested file, or else...
        connection.SendView(views.View{Name: "Welcome"}) // ...sends view "Welcome".
    })
}
```
...
func Welcome(connection *connections.Connection) {
    connection.SendView(views.View{         // Sends a view.
        Name: "Welcome",                    // Sets the view's name.
        RenderMode: views.RenderModeClient, // Renders the view only on the client.
    })
}
```
