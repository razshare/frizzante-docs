...
func GetHello(req *frizzante.Request, res *frizzante.Response) {
    // Sends file "lib/components/views/Hello.svelte"
    res.SendView(frizzante.View{Name: "Hello"}) 
}
```

## Views Data

Optionally, you can send data along with the views by adding a `Data` property to your `frizzante.View`.
