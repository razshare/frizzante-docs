...
out of the box, which you can find in [app/frizzante/core/components/*](https://github.com/razshare/frizzante/tree/main/template/project/app/frizzante/core/components).
