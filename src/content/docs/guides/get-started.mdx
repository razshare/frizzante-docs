...
Frizzante is an opinionated web server framework written in Go that uses Svelte to render pages.

:::note
#### Prerequisites

Make sure you have `frizzante`, `bun`, `build-essential`, `curl` and `unzip` installed on your machine.
