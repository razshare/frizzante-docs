...
:::note
This will create `app/lib/utilities`.\
These utilities are the glue code between Go and Svelte.
:::

:::tip
The reason these utilities are generated instead of being 
distributed as a library is so that you can easily 
customize your glue code if you need to.
:::
...
by replacing all `bun` and `bunx` references within the makefile with 
