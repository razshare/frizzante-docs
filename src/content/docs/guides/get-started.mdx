...
<Tabs>
    ...
    <TabItem icon='seti:docker' label='Docker'>
        ...
        :::tip
        You can attach to this container with your IDE or directly from your shell.\
        This will allow you to start debugging your application without [Delve](https://github.com/go-delve/delve).
        ```sh
        docker exec -it <mycontainer> sh   
        ```
        :::

        Alternatively, you can start the development server inline.
