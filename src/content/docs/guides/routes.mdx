...
Define an `init()` function and use `Server.WithRoute()` to define a request handler.
...
func init() {
	Server.WithRoute("GET /", func(req *f.Request, res *f.Response) {
...
func init() {
	Server.WithRoute("GET /{name}", func(req *f.Request, res *f.Response) {
        //...
    })
}
```
    ...
    <TabItem label='Server'>
        ...
        func init() {
            Server.WithRoute("GET /", func(req *f.Request, res *f.Response) {
                res.SendView(f.View{
                    Name: "Welcome",
                    RenderMode: f.RenderModeServer, // Renders on server.
                })
            })
        }
        ```
    ...
    <TabItem label='Client'>
        ...
        func init() {
            Server.WithRoute("GET /", func(req *f.Request, res *f.Response) {
                res.SendView(f.View{
                    Name: "Welcome",
                    RenderMode: f.RenderModeClient, // Renders on client.
                })
            })
        }
        ```
    ...
    <TabItem label='Full'>
        ...
        func init() {
            Server.WithRoute("GET /", func(req *f.Request, res *f.Response) {
                res.SendView(f.View{
                    Name: "Welcome",
                    RenderMode: f.RenderModeFull,   // Renders on client and server.
                })
            })
        }
        ```
...
func init() {
	Server.WithRoute("GET /", func(req *f.Request, res *f.Response) {
        ...
        res.SendStatus(200)         // Sending status.  (Will Fail)
    })
}
```
