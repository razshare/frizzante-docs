    ...
    <TabItem label='Server'>
        ...
        func init() {
            Server.WithRequestHandler("GET /", func(req *f.Request, res *f.Response) {
                res.SendView(f.View{
                    Name: "Welcome",
                    RenderMode: f.RenderModeServer, // Renders only on the server.
                })
            })
        }
        ```
    ...
    <TabItem label='Client'>
        ...
        func init() {
            Server.WithRequestHandler("GET /", func(req *f.Request, res *f.Response) {
                res.SendView(f.View{
                    Name: "Welcome",
                    RenderMode: f.RenderModeClient, // Renders only on the client.
                })
            })
        }
        ```
    ...
    <TabItem label='Full'>
        ...
        func init() {
            Server.WithRequestHandler("GET /", func(req *f.Request, res *f.Response) {
                res.SendView(f.View{
                    Name: "Welcome",
                    RenderMode: f.RenderModeFull,   // Renders on both the client and the server.
                })
            })
        }
        ```
