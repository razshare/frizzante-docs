import{t as e}from"./code.js";import{B as t,E as n,G as r,J as i,K as a,O as o,P as s,R as c,W as l,q as u,z as d}from"./index-Bb2b0DQE.js";import{o as f}from"./navbar.js";import{i as p,n as m,r as h,t as g}from"./title.js";import{t as _}from"./inline_code.js";var v=o(`<!> <span>Use <!> to upgrade the connection to web sockets.</span> <!> <span>Then consume the web socket on the client.</span> <!>`,1);function y(o,y){a(y,!0),h(o,{title:`Web Sockets`,get prefix(){return y.prefix},rightSidebar:(e,t)=>{let n=()=>(t?.()).body;m(e,{get body(){return n()},items:[{shift:0,text:`Web Sockets`}]})},footer:e=>{{let t=l(()=>({label:`Basics`,href:f(`/basics`,{prefix:y.prefix})})),n=l(()=>({label:`Server Sent Events`,href:f(`/server_sent_events`,{prefix:y.prefix})}));p(e,{get previous(){return s(t)},get next(){return s(n)}})}},children:(r,a)=>{var o=v(),s=d(o);g(s,{text:`Web Sockets`});var l=t(s,2);_(t(c(l)),{source:`negotiate.WsUpgrade()`}),u(),i(l);var f=t(l,2);e(f,{lang:`go`,source:`
            package main
