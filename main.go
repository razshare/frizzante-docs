...
var appRoutes = []routes.Route{
	{Pattern: "GET /", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
	...
	{Pattern: "GET /get_started", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "GetStarted", Props: props})
	}},
	{Pattern: "GET /basics", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Basics", Props: props})
	}},
	{Pattern: "GET /build_checkpoints", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "BuildCheckpoints", Props: props})
	}},
	{Pattern: "GET /web_sockets", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "WebSockets", Props: props})
	}},
	{Pattern: "GET /server_sent_events", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "ServerSentEvents", Props: props})
	}},
	{Pattern: "GET /guards", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Guards", Props: props})
	}},
	{Pattern: "GET /views", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Views", Props: props})
	}},
	{Pattern: "GET /web_standards", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "WebStandards", Props: props})
	}},
	{Pattern: "GET /type_definitions", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "TypeDefinitions", Props: props})
	}},
	{Pattern: "GET /todos_example", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
	...
	{Pattern: "GET /snapshots", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Snapshots", Props: props})
	}},
	{Pattern: "GET /docker", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Docker", Props: props})
	}},
	{Pattern: "GET /issues", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Issues", Props: props})
	}},
	{Pattern: "GET /contributing", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Contributing", Props: props})
	}},
	{Pattern: "GET /faq", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
		send.View(writer, request, render, views.View{Name: "Faq", Props: props})
	}},
	{Pattern: "GET /full_screen_menu", Handler: func(_ scopes.Scope, request *http.Request, writer http.ResponseWriter) {
